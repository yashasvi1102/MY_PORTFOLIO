...
const portfolioData = {
  ...
  projects: [
    { id: 1, title: "MediQuery – Clinical Analytics Platform with Safety-First AI", description: "Designed a healthcare analytics platform processing 10K+ synthetic FHIR patient records through Snowflake Medallion architecture with dbt. Built a Neo4j GraphRAG agent with mandatory citation guards, 4-tier RBAC (Doctor, Researcher, Admin, Patient), and a natural-language cohort builder achieving 92%+ precision on adverse event detection.", tags: ["FHIR", "Snowflake", "Neo4j", "GraphRAG", "dbt"], github: "https://github.com/yashasvi1102/mediquery" },
    { id: 2, title: "CrimeGraphRAG – AI Crime Investigation Assistant", description: "Built an AI-powered investigation system using Neo4j and GraphRAG. Designed a knowledge graph connecting crimes, suspects, organizations, and locations with natural language querying capabilities.", tags: ["Neo4j", "GraphRAG", "Streamlit", "Python"], github: "https://github.com/yashasvi1102/CrimeGraphRAG-AI-Crime-Investigation-Assistant" },
    { id: 3, title: "Emotion Recognition in Multi-Turn Conversations", description: "Built a context-aware emotion detection system using the MELD dataset (13k+ utterances). Implemented BERT, DialogueRNN, and attention-based models achieving 70.4% accuracy across 7 emotional categories.", tags: ["PyTorch", "BERT", "NLP", "Streamlit"], github: "https://github.com/yashasvi1102/Emmotion-Recognition-in-Multi-Turn-Conversations" },
    { id: 4, title: "End-to-End LA Crime Analytics – Medallion Architecture", description: "Designed and implemented a complete data lakehouse solution using Databricks with Bronze, Silver, and Gold layers for LA crime data analysis. Built scalable ETL pipelines for crime trend analytics.", tags: ["Databricks", "Medallion", "Spark", "Azure"], github: "https://github.com/yashasvi1102/End-to-End-LA-Crime-Analytics-Medallion-Architecture-" },
    { id: 5, title: "IMDB Project", description: "A comprehensive IMDb data analysis project featuring database design, data modeling, and analytics on movie ratings, cast information, and box office performance trends.", tags: ["SQL", "Data Modeling", "Analytics"], github: "https://github.com/yashasvi1102/IMDb-Team-Project" },
    { id: 6, title: "Wine Quality Prediction", description: "A machine learning project analyzing wine quality factors using R. Implements various ML algorithms for quality prediction based on chemical properties and sensory data.", tags: ["R", "Data Analysis", "ML"], github: "https://github.com/yashasvi1102/Wine-Quality-Project" },
      ...
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .hero-image-container {
          ...
          padding: 6px;
          background: var(--gradient-1);
          box-shadow: 0 0 60px var(--primary-glow), 0 0 100px rgba(0, 212, 255, 0.15);
          animation: pulseGlow 3s ease-in-out infinite;
        }
        
        @keyframes pulseGlow {
          0%, 100% { box-shadow: 0 0 60px var(--primary-glow), 0 0 100px rgba(0, 212, 255, 0.15); }
          50% { box-shadow: 0 0 80px var(--primary-glow), 0 0 140px rgba(0, 212, 255, 0.25); }
        }
